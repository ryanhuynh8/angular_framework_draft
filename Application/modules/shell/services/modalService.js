...
define([],function () {
    var modalDefaults = {
        ...
        keyboard: true,
        modalFade: true,
        templateUrl: '/Application/modules/shell/partials/modal.html'
    };
    ...
    var sv;
    //-------------Defined contructor of class CustomerOrdersController-------------------
    ...
    ModalService.prototype.show = function (customModalDefaults, customModalOptions) {
        ...
        return sv.modal.open(tempModalDefaults).result;
    };
    ...
    angular.module('shell').service('modalService', ModalService);
});